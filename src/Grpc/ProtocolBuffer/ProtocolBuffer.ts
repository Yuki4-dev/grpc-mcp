...
export const equalsProtocolBufferService = (
  a: ProtocolBufferService,
  b: ProtocolBufferService,
) => {
...
export const equalsProtocolBufferMethod = (
  a: ProtocolBufferMethod,
  b: ProtocolBufferMethod,
) => {
  return a.name === b.name;
};
...
export type ProtocolBufferMessageFieldType =
  | "string"
  | "number"
  | "long"
  | "boolean"
...
export type ProtocolBufferErrorCode =
  (typeof protocolBufferErrorCodeArray)[number];
...
export const protocolBufferMethodForEach = (
  ...
  callback: (
    ...
    service: ProtocolBufferService,
    method: ProtocolBufferMethod,
  ) => boolean | void,
) => {
