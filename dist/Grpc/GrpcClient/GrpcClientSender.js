...
class GrpcClientSender {
    ...
    async sendAsync(request) {
        ...
        const client = this.grpcClientFactory.create(request.address.host +
            (request.address.port ? ":" + request.address.port : ""), request.request.service, proto, option);
    ...
    validateRequest(request) {
        ...
        if (request.address.port !== undefined &&
